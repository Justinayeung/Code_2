...
//}
//void draw() {
////A switch statement switches the at a variable until break;
////Faster to use switch then if, else because it saves time and you can do level up
//  switch (STATE) {
//    case 0: // start screen
//      showStartScreen();
//    break;
...
// there is time delay with millis() so totalTime + startTIme is more closer to the accurate time
//float totalTime = 3;
//int startTime;
//void setup() {
//  size(400, 600);
...
//  // millis() is always updating, so you use startTime in order for you to get a number(millis()) at that specific key press
//  startTime = millis();
...
//2000(millis()) - 1000(startTime) = 1000 meaning it is one second since the key was pressed
//  if (millis() - startTime > totalTime) {
//    //OR (millis() > totalTime + startTIme) {
//    isActive = false;
//  }
//}
